...
export default function ThankYouPage() {
  return (
    <div className="relative   bg-white overflow-hidden">
      ...
      <svg className="absolute hidden  lg:block -left-32 -top-48"  width="1101" height="1216" viewBox="0 0 1101 1216" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center h-[70vh] lg:h-screen justify-end">
      ...
      <div className="relative z-10 max-3xl text-start md:text-left px-6">
        ...
        <div className="mt-5 inline-flex items-center gap-2 text-[#0097DC]  font-bold text-lg lg:text-[24px]  cursor-pointer">
          <ChevronLeft size={30} />
          <Link href="/work-space">Go Back</Link>
        </div>
      </div>
      </div>
    </div>
