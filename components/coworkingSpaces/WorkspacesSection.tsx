...
export default function WorkspacesSection() {
  return (
    <section className="bg-[#F8F8F8] py-12 sm:py-16 px-4 sm:px-6 lg:px-12">
      <div className="sm:px-6 lg:px-28 mx-auto grid overflow-hidden grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
        {/* 🖼️ Left Image Collage */}
        <div className="relative bg-white  col-span-12 lg:col-span-4 flex justify-center items-center overflow-hidden min-h-[320px] sm:min-h-[420px] lg:min-h-[500px] xl:min-h-[600px]">
          {/* Top-left Image */}
          <div className="absolute top-2 sm:top-3 z-10 left-0 w-[68%] sm:w-[70%] h-[140px] sm:h-[220px] md:h-[260px] lg:h-[280px] overflow-hidden ">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-[70%] sm:w-[65%] h-[160px] sm:h-[200px] md:h-[240px] lg:h-[260px] overflow-hidden ">
        ...
        <div className="col-span-12 lg:col-span-8 mt-10 lg:mt-0">
          <h2 className="text-2xl md:text-3xl lg:text-[48px] font-semibold text-primary mb-4">Workspaces Designed Around You</h2>
