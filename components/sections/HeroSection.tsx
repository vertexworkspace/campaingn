...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full px-4 sm:px-6 lg:px-20 bg-white py-10 overflow-hidden">
      {/* ✅ RIGHT SIDE - SWIPER */}
      ...
      <div className="hidden lg:block lg:absolute top-1/2 -translate-y-1/2 left-6 sm:left-10 lg:left-[5%] bg-white w-[90%] sm:w-[80%] md:w-[60%] lg:w-[45%] xl:w-[35%] p-6 sm:p-10 z-10">
